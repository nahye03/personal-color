FlowRouter.template('/reco_brusher', 'reco_brusher');

Template.reco_brusher_info.onRendered(function () {

});

Template.reco_brusher_info.helpers({
    toneInfo: function() {
    ...
    COSInfo: function() {
        ...
        return DB_COSM.findAll({cm_tone:tonename, cm_class:"blusher"});
    }
