FlowRouter.template('/reco_base', 'reco_base');

Template.reco_base_info.onRendered(function () {

});

Template.reco_base_info.helpers({
    toneInfo: function() {
    ...
    COSInfo: function() {
        ...
        return DB_COSM.findAll({cm_tone:tonename, cm_class:"base"});
    }
