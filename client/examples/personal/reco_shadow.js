FlowRouter.template('/reco_shadow', 'reco_shadow');

Template.reco_shadow_info.onRendered(function () {

});

Template.reco_shadow_info.helpers({
    toneInfo: function() {
    ...
    COSInfo: function() {
        ...
        return DB_COSM.findAll({cm_tone:tonename, cm_class:"shadow"});
    }
